 ...
 * aparece nesta planilha. A regra do dominio {@code enviar != conversa} continua valendo: so
 * eventos originados de uma interacao com o cliente viram {@link SinalEngajamento}.
 */
